          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Input
                ...
                required
                className="w-full bg-secondary/50 border-border focus:border-neon-green/50 focus:ring-neon-green/20 transition-all duration-200"
            ...
            <div>
              ...
              <Textarea
                ...
                required
                rows={6}
                className="w-full bg-secondary/50 border-border focus:border-neon-green/50 focus:ring-neon-green/20 transition-all duration-200 resize-none"
