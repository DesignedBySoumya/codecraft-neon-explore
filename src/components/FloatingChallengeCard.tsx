      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2">
              <span className={`${getDifficultyClass(challenge.difficulty)} px-2 py-1 rounded text-xs font-medium`}>
        ...
        <div className="flex items-center gap-4 mb-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-1">
            ...
            <span className="text-neon-green font-semibold">+{challenge.xp} XP</span>
          </div>
          <div className="flex items-center gap-1">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {challenge.tags.slice(0, 3).map((tag) => (
            <motion.span
              key={tag}
              className="px-2 py-1 bg-secondary/50 text-xs rounded-full text-muted-foreground border border-border"
              whileHover={{ scale: 1.05, borderColor: 'rgba(0, 255, 163, 0.5)' }}
            >
              #{tag}
            </motion.span>
          ))}
