    ...
    <div className="relative">
      ...
      <div className="flex justify-between items-center mb-6">
        <Button
          ...
          size="icon"
          onClick={() => paginate(-1)}
          className="rounded-full border-neon-green/30 hover:border-neon-green hover:shadow-neon"
        >
            ...
            <div className="challenge-card h-full p-6 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <Badge className={`${getDifficultyClass(challenges[currentIndex].difficulty)} px-3 py-1`}>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {challenges[currentIndex].tags.map((tag) => (
                    <Badge key={tag} variant="outline" className="border-neon-green/30 text-neon-green">
                      {tag}
                    </Badge>
                  ))}
                </div>
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
                  ...
                  <span>👥 {challenges[currentIndex].solvers.toLocaleString()} solved</span>
                </div>
              </div>
