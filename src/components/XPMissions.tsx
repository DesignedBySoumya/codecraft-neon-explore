...
const missions = [
  ...
  { id: 2, title: 'Complete 1 Medium', reward: 100, completed: false, type: 'daily' },
  { id: 3, title: 'Review 1 Solution', reward: 25, completed: false, type: 'daily' },
  { id: 4, title: 'Solve in < 30 min', reward: 75, completed: false, type: 'bonus' },
  { id: 5, title: 'First Try Success', reward: 150, completed: false, type: 'bonus' }
];
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1">
                ...
                <span className="text-yellow-400 font-semibold">+{mission.reward} XP</span>
              </div>
