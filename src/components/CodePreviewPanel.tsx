...
const CodePreviewPanel = ({ isOpen, onClose, challenge }: CodePreviewPanelProps) => {
  const [isTyping, setIsTyping] = useState(false);

  const sampleCode = challenge?.code || `function twoSum(nums, target) {
  const map = new Map();
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 p-6 overflow-auto">
              ...
              >
                <h4 className="text-sm font-semibold text-neon-green mb-2">Output:</h4>
