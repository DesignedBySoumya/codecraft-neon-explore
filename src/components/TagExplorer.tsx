            ...
            <motion.button
              ...
              className={`pill-shaped px-4 py-2 rounded-full border transition-all duration-300 whitespace-nowrap ${
                selectedTag === tag.name
                  ...
                  : 'bg-secondary/50 backdrop-blur border-border text-foreground hover:border-neon-green/50 hover:bg-neon-green/10'
              }`}
      ...
      {selectedTag && (
        ...
        >
          <p className="text-muted-foreground">
            Showing challenges tagged with <span className="text-neon-green font-semibold">#{selectedTag}</span>
          </p>
        </motion.div>
      )}
    </div>
