  ...
  return (
    ...
    >
      <div className="glass-card p-8 rounded-2xl relative overflow-hidden">
        ...
        >
          <Badge className="bg-accent text-black font-bold px-3 py-1 shadow-accent-glow">
            ⭐ WEEKLY PICK
          </Badge>
        </motion.div>
        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1">
              ...
              >
                A classic dynamic programming challenge that every developer should master. 
              ...
              >
                ...
                <Badge variant="outline" className="border-neon-green/30 text-neon-green">Dynamic Programming</Badge>
                <Badge variant="outline" className="border-neon-green/30 text-neon-green">Arrays</Badge>
              </motion.div>
              ...
              >
                <p className="italic">
                  "Handpicked by the Loveable Team - This challenge perfectly demonstrates 
                  the elegance of dynamic programming and is asked in 70% of technical interviews."
                </p>
              </motion.div>
            </div>
